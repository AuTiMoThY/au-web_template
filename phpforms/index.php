...
<body class="documenter-project-phpforms">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            'use strict';
            if (top == self) {
                $('#buy').html('<a href="http://codecanyon.net/item/php-form-class-for-bootstrap-3/8790160" class="btn btn-success btn-large" id="buy-btn">Buy on Codecanyon ! <span class="glyphicon glyphicon-hand-right append"></span></a>');
            }
