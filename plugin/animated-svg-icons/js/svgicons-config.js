var path = 'plugin/AnimatedSVGIcons/';
var svgIconConfig = {
	clock : { 
		url : path+'svg/clock.svg',
		animation : [
			{ 
				el : 'path:nth-child(2)', 
				animProperties : { 
	...
	navLeftArrow : {
		url : path+'svg/nav-left-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
