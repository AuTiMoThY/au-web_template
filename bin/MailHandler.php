<?
    ...
    // 寄送通知信         
    $temp_mail_to = "m62466@gmail.com, goothlogo@gmail.com";
    //$temp_mail_to = "mao@ecmd.com.tw";
     
    $temp_mail_subject=" 谷思設計-聯絡我們新訊息 ";
    $subject = "=?UTF-8?B?" . base64_encode($temp_mail_subject) . "?=";
     
    $message = "<html><head><title>谷思設計 - 聯絡我們表單</title></head><meta http-equiv=Content-Type content='text/html; charset=utf-8'><body>";
    ...
    $temp_mail_headers.= "From: 谷思設計<goothlogo@gmail.com> \n"; 
	$temp_mail_message=$temp_mail_content; 
    $result = mail($temp_mail_to,$subject,$message,$temp_mail_headers); 
	
	// 寄給開案人       
    $temp_mail_subject=" 您在 谷思設計 http://goothlogo.com.tw/ 的留言 ";
    $subject = "=?UTF-8?B?" . base64_encode($temp_mail_subject) . "?=";
